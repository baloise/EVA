  ...
  <body>
    ...
    <div id="pageContents" style="opacity: 0;">
      ...
      <footer class="footer" id="slideMeFoot" style="display: none;">
        <div class="container">
            <a class="foot-link" href="modul/settings/settings.php"><?php echo $translate["Einstellungen"] ?></a><i class="text-muted"> | <?php echo $_SESSION["user"]['username']; ?></i><span class="text-muted">©<a href="https://eliareutlinger.ch"> Elia Reutlinger</a> | 2018 | EVA <a href="https://github.com/baloise/BALET">v.1.0</a></span>
        </div>
      </footer>
    </div>
