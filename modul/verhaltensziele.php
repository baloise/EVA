...
<?php elseif($session_usergroup == 2) : //PA ?>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <td><button type="button" class="btn btn-warning checkEntry" style="padding-bottom: 0px; padding-top: 0px;"><b>!</b></button></td>
                <th scope="row">1</th>
                <td>Helpdesk</td>
                <td>50</td>
                <td>Elia Reutlinger</td>
                <td>08.01.2018</td>
            </tr>
            <tr>
                <td><button entryID="" type="button" class="btn btn-warning checkEntry" style="padding-bottom: 0px; padding-top: 0px;"><b>!</b></button></td>
                <th scope="row">2</th>
                <td id="">ITCH</td>
                <td>55</td>
                <td>Elia Reutlinger</td>
    ...
    <div id="checkEntryForm" style="display: none;">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <button type="button" entryID="" id="fsendAndDelete" class="btn btn-danger">Abschicken & Eintrag löschen</button>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p>Beim Abschiscken werden die verantwortlichen Personen per E-Mail benachrichtigt, um den Eintrag zu überprüfen.</p>
            </div>
        </div>
    </div>
